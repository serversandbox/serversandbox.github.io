...
![catssssss](img/jellyfin-cats.png)

What can I say, it's pretty great.

I also tried [Cloudflare tunnels](https://developers.cloudflare.com/cloudflare-one/connections/connect-networks/) (using Ansible to provision it) to flex my vanity `milly.ashford.academy` domain. 
